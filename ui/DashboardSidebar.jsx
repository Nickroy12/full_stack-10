...
export default function DashboardSidebar() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="md:hidden border-b border-zinc-200 dark:border-zinc-800 p-4 flex justify-between items-center bg-background">
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-zinc-200 dark:border-zinc-800">
            ...
            <button onClick={() => setOpen(false)} className="text-zinc-600 dark:text-zinc-400 dynamic-hover">
              <X size={22} />
            </button>
          </div>
